      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 italic">
              __Let's connect and create something together__
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-medium text-black mb-6">Let's Connect</h3>
                <p className="text-gray-600 leading-relaxed mb-8">
                  ...
                  about one of my blog posts or want to discuss a potential collaboration, 
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Earth, Solar System</p>
                  </div>
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-medium text-black">Response Time</h4>
